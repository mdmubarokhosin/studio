...
const Footer = () => {
  return (
    <footer id="contact" className="bg-secondary text-secondary-foreground pt-12 pb-24 md:pb-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          <div>
            <h3 className="font-headline text-lg font-bold mb-4 text-primary">{appName}</h3>
          ...
          <div>
            <h3 className="font-headline text-lg font-bold mb-4">যোগাযোগ</h3>
            ...
            <p className="text-sm flex items-center justify-center md:justify-start gap-2 mt-2"><Mail className="w-4 h-4 text-accent" /> {footerContent.email}</p>
          </div>
          <div>
