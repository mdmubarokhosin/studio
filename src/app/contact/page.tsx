      ...
      <main className="flex-1 py-8 md:py-16">
        <div className="container mx-auto px-4">
           <div className="text-center mb-8 md:mb-12">
                <h2 className="font-headline text-2xl md:text-4xl font-bold text-primary">যোগাযোগ</h2>
                <p className="mt-3 md:mt-4 max-w-2xl mx-auto text-sm md:text-base text-muted-foreground">ভর্তি বা অন্য যেকোনো তথ্যের জন্য আমাদের সাথে যোগাযোগ করুন।</p>
            </div>
            <div className="grid md:grid-cols-2 gap-8 md:gap-12">
                <div>
                    <h3 className="font-headline text-xl md:text-2xl font-bold mb-6">যোগাযোগের তথ্য</h3>
                    <div className="space-y-4">
                         <p className="flex items-start gap-3 text-sm md:text-base">
                            <MapPin className="w-5 h-5 md:w-6 md:h-6 text-accent mt-1" />
                            <span>
                         ...
                         <p className="flex items-start gap-3 text-sm md:text-base">
                            <Phone className="w-5 h-5 md:w-6 md:h-6 text-accent mt-1" />
                             <span>
                         ...
                         <p className="flex items-start gap-3 text-sm md:text-base">
                            <Mail className="w-5 h-5 md:w-6 md:h-6 text-accent mt-1" />
                             <span>
                     ...
                     <div className="mt-8">
                        <h4 className="font-headline text-lg md:text-xl font-bold mb-4">আমাদের অবস্থান</h4>
